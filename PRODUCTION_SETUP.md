...
✅ API URL: http://10.229.73.52:5000/api
...
```bash
curl http://10.229.73.52:5000/api/health
```
...
### **2. Test OTP Endpoint**
```bash
curl -X POST http://10.229.73.52:5000/api/auth/send-otp \
...
```bash
# Already configured: 10.229.73.52
# To verify:
...
```
http://10.229.73.52:5000/api/health
```
...
🌐 Network: http://10.229.73.52:5000/api
...
**Should show:**
```
› Metro waiting on exp://10.229.73.52:8081
...
Open in phone browser: `http://10.229.73.52:5000/api/health`
...
**Test login flow:**
1. Send OTP: `curl -X POST http://10.229.73.52:5000/api/auth/send-otp -H "Content-Type: application/json" -d '{"phone":"9876543210"}'`
...
- [x] API URL set to network IP (`10.229.73.52`)
